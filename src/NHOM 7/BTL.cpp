...
void HocSinh::Xuat4(){
    ...
    cout<<endl<<"\t"<<setw(5)<<left<<STT<<setw(23)<<left<<Ten<<setw(15)<<left<<DiaChi<<setw(15)<<left<<MSHS<<left<<Ngay<<"/"<<Thang<<"/"<<setw(12)<<left<<Nam<<setw(17)<<left<<Toan<<setw(10)<<left<<Ly<<setw(10)<<left<<Hoa<<setw(10)<<left<<Van<<setw(10)<<left<<Su<<setw(10)<<left<<Dia<<setw(10)<<left<<DTB<<endl;
    cout<<"\t"<<setfill('-')<<setw(150)<<"-"<<endl;
    cout<<setfill(' ');
}
void HocSinh::Xuat5(){

    cout<<endl<<"\t"<<setw(5)<<left<<STT<<setw(23)<<left<<Ten<<setw(15)<<left<<DiaChi<<setw(15)<<left<<MSHS<<left<<Ngay<<"/"<<Thang<<"/"<<setw(12)<<left<<Nam<<setw(17)<<left<<Toan<<setw(10)<<left<<Ly<<setw(10)<<left<<Hoa<<setw(10)<<left<<Van<<setw(10)<<left<<Su<<setw(10)<<left<<Dia<<setw(10)<<left<<DTB;
}
...
bool quanlyHS::check (string h){
 ...
 void quanlyHS::XuatThongTinChung(){
        cout<<endl<<"\t\t\t\t\t\t\t\t\t\tTHONG TIN HOC SINH \n"<<endl;
   	    cout<<"\t"<<setw(5)<<left<<"STT "<<setw(23)<<left<<"Ten"<<setw(15)<<left<<"Dia Chi"<<setw(15)<<left<<"MSHS"<<setw(15)<<left<<"Ngay Sinh"<<setw(18)<<left<<"Toan "<<setw(10)<<left<<"Ly"<<setw(10)<<left<<"Hoa"<<setw(10)<<left<<"Van"<<setw(10)<<left<<"Su"<<setw(10)<<left<<"Dia"<<setw(10)<<"DTB"<<endl;
   	    cout<<"\t"<<setw(150)<<setfill('_')<<"_"<<endl;
        cout<<setfill(' ');
}    
 void quanlyHS::XuatThongTinChung2(){
        cout<<endl<<"\t\t\t\t\t\t\t\t\t\tTHONG TIN HOC SINH \n"<<endl;
   	    cout<<"\t"<<setw(5)<<left<<"STT "<<setw(23)<<left<<"Ten"<<setw(15)<<left<<"Dia Chi"<<setw(15)<<left<<"MSHS"<<setw(15)<<left<<"Ngay Sinh"<<setw(18)<<left<<"Toan "<<setw(10)<<left<<"Ly"<<setw(10)<<left<<"Hoa"<<setw(10)<<left<<"Van"<<setw(10)<<left<<"Su"<<setw(10)<<left<<"Dia"<<setw(10)<<"DTB"<<setw(10)<<left<<"Xep Loai"<<endl;
   	    cout<<"\t"<<setw(160)<<setfill('_')<<"_"<<endl;
        cout<<setfill(' ');
}    
...
void quanlyHS::XepLoaiHS(){
	...
	for(int i = 0 ;i < this->HS.size();i++){
		if(HS.at(i)->getDTB() >= 8){
			HS.at(i)->Xuat5(); cout<<setw(10)<<left<<"GIOI \n";
            cout<<"\t"<<setfill('-')<<setw(160)<<"-"<<endl;
            cout<<setfill(' ');
		}
		else if( HS.at(i)->getDTB()<8 && HS.at(i)->getDTB() >= 6.5 ){
			HS.at(i)->Xuat5(); cout<<setw(10)<<left<<"KHA \n";
            cout<<"\t"<<setfill('-')<<setw(170)<<"-"<<endl;
            cout<<setfill(' ');
		}   
		else if( HS.at(i)->getDTB() <6.5 && HS.at(i)->getDTB() >= 5){
			HS.at(i)->Xuat5(); cout<<setw(10)<<left<<"TRUNG BINH \n";
            cout<<"\t"<<setfill('-')<<setw(160)<<"-"<<endl;
            cout<<setfill(' ');
		}   
		
		else{
			HS.at(i)->Xuat5(); cout<<setw(10)<<left<<"YEU \n";
            cout<<"\t"<<setfill('-')<<setw(160)<<"-"<<endl;
            cout<<setfill(' ');
		}  
...
void quanlyHS::exportHS(ofstream &file){
    ...
    file<<endl<<"\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tTHONG TIN HOC SINH \n"<<endl;
   	file<<"\t"<<setw(5)<<left<<"STT "<<setw(30)<<left<<"Ten"<<setw(15)<<left<<"Dia Chi"<<setw(15)<<left<<"MSHS"<<setw(15)<<left<<"Ngay Sinh"<<setw(18)<<left<<"Toan "<<setw(15)<<left<<"Ly"<<setw(15)<<left<<"Hoa"<<setw(15)<<left<<"Van"<<setw(15)<<left<<"Su"<<setw(15)<<left<<"Dia"<<setw(15)<<"DTB"<<setw(15)<<endl;
